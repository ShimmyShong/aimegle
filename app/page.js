    ...
    <>
      <div className="mx-auto p-4">
        ...
        <div className="mx-auto">
          <div className='mt-6 py-4 overflow-auto w-full h-[80vh] bg-white shadow-sm ring-1 ring-inset ring-gray-300 rounded-t-xl' ref={chatBoxRef}>
          ...
          <div>
            <div className="mt-2">
              <form onSubmit={(e) => handleSubmit(e) & setUserInput('')} autoComplete='off' className='flex flex-row gap-3'>
                <button
                  type="button"
                  className="rounded-bl-xl bg-white font-semibold text-black py-2 min-w-[10%] hover:bg-slate-50 active:bg-slate-100 shadow-sm ring-1 ring-inset ring-gray-300"
                >
                  Disconnect
                </button>
                <input
                  ...
                  value={userInput}
                  className="block w-full border-0 p-[2rem] text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6"
                />
                <button
                  type="submit"
                  className="rounded-br-xl bg-white font-semibold text-black py-2 min-w-[10%] hover:bg-slate-50 active:bg-slate-100 shadow-sm ring-1 ring-inset ring-gray-300"
                >
                  Send
                </button>
              </form>
